...
export default function Linguguens() {
  ...
  return (
    ...
    >
      {/* py-24 md:pb-0 */}
      <div className="container mx-auto max-w-4xl p-6 pt-6 pb-20  md:pt-10 ">
        ...
        <div className="grid grid-cols-2 font-semibold gap-4 md:grid-cols-3 lg:grid-cols-4 ">
          {skills.map((skill, index) => (
            ...
            >
              <div
                className=" relative flex w-40 items-center justify-center rounded-tl-[60px]
                       bg-white p-4 aspect-square flex-col border-b-8 border-green-500/75"
              >
                <h4 className="font-semibold text-green-700 mb-6 ">
                  {skill.name}
                </h4>
